...
contentHtml.innerHTML +=
  "<strong>CIA: Intentando reclutar a James Bond por segunda vez...</strong><br>";
cia.toRecruitAgent(jamesbond)
  ? (contentHtml.innerHTML += "El agente James Bond ha sido reclutado.<br>")
  : (contentHtml.innerHTML += "El agente James Bond ya está reclutado.<br>");

//To fire spies
contentHtml.innerHTML += "<br><strong>Cesando agentes...</strong><br>";
contentHtml.innerHTML += "Cesando a Juan: ";
cia.toFireAgent("Juan")
  ? (contentHtml.innerHTML += "El agente Juan ha sido cesado.<br>")
  : (contentHtml.innerHTML += "No existe ningún agente con ese nombre.<br>");
contentHtml.innerHTML += "Cesando a Margaretha Geertruida: ";
cia.toFireAgent("Margaretha Geertruida")
  ? (contentHtml.innerHTML +=
      "El agente Margaretha Geertruida ha sido cesado.<br>")
  : (contentHtml.innerHTML += "No existe ningún agente con ese nombre.<br>");
contentHtml.innerHTML += "Cesando a Vitaly Yurchenko: ";
kgb.toFireAgent("Vitaly Yurchenko")
  ? (contentHtml.innerHTML += "El agente Vitaly Yurchenko ha sido cesado.<br>")
  : (contentHtml.innerHTML += "No existe ningún agente con ese nombre.<br>");
contentHtml.innerHTML += cia.toString() + "<br>";
contentHtml.innerHTML += kgb.toString() + "<br>";
